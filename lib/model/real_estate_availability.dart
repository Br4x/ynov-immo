...
/* à */
  ...
  static List<RealEstateAvailability> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RealEstateAvailability>()
        : json
            .map((value) => new RealEstateAvailability.fromJson(value))
            .toList();
  }

  static Map<String, RealEstateAvailability> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RealEstateAvailability>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RealEstateAvailability.fromJson(value));
    }
    return map;
  }
}

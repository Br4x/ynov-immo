...
class ChatCommentApi {
  final ApiClient apiClient;

  ChatCommentApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<ChatCommentPagination> chatCommentGet({ List<String> where, String fields, String order, int offset, int limit }) async {
    ...
    String path = "/chat-comment".replaceAll("{format}","json");
  ...
  Future<ApiResponse> chatCommentIdDelete(int id) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/chat-comment/{Id}".replaceAll("{format}","json").replaceAll("{" + "Id" + "}", id.toString());
  ...
  ///
  /// get a chat-comment by ID
  Future<ChatComment> chatCommentIdGet(int id) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'ChatComment') as ChatComment ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// update chat-comment
  Future<ApiResponse> chatCommentPatch(ChatComment body) async {
  ...
  ///
  /// create chat-comment
  Future<ApiResponse> chatCommentPost(ChatComment body) async {
    Object postBody = body;
